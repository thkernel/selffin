class FeaturesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @feature.save
        @features = Feature.all
        format.html { redirect_to @feature, notice: 'Enregistrer avec succès.' }
  ...
  def update
    respond_to do |format|
      if @feature.update(feature_params)
        @features = Feature.all
        format.html { redirect_to @feature, notice: 'Modifier avec succès.' }
  ...
  def destroy
    @feature.destroy
    respond_to do |format|
      format.html { redirect_to features_url, notice: 'Supprimer avec succès.' }
