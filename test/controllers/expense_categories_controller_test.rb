...
class ExpenseCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expense_category" do
    assert_difference('ExpenseCategory.count') do
      post expense_categories_url, params: { expense_category: { name: @expense_category.name, priority_id: @expense_category.priority_id, status: @expense_category.status, uid: @expense_category.uid, user_id: @expense_category.user_id } }
    end
  ...
  test "should update expense_category" do
    patch expense_category_url(@expense_category), params: { expense_category: { name: @expense_category.name, priority_id: @expense_category.priority_id, status: @expense_category.status, uid: @expense_category.uid, user_id: @expense_category.user_id } }
