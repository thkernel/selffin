...
class IncomeTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create income_type" do
    assert_difference('IncomeType.count') do
      post income_types_url, params: { income_type: { description: @income_type.description, name: @income_type.name, status: @income_type.status, uid: @income_type.uid, user_id: @income_type.user_id } }
    end
  ...
  test "should update income_type" do
    patch income_type_url(@income_type), params: { income_type: { description: @income_type.description, name: @income_type.name, status: @income_type.status, uid: @income_type.uid, user_id: @income_type.user_id } }
