...
class SavingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create saving" do
    assert_difference('Saving.count') do
      post savings_url, params: { saving: { amount: @saving.amount, bank_id: @saving.bank_id, description: @saving.description, designation: @saving.designation, status: @saving.status, uid: @saving.uid, user_id: @saving.user_id } }
    end
  ...
  test "should update saving" do
    patch saving_url(@saving), params: { saving: { amount: @saving.amount, bank_id: @saving.bank_id, description: @saving.description, designation: @saving.designation, status: @saving.status, uid: @saving.uid, user_id: @saving.user_id } }
