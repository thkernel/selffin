...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference('Wallet.count') do
      post wallets_url, params: { wallet: { description: @wallet.description, name: @wallet.name, status: @wallet.status, uid: @wallet.uid, user_id: @wallet.user_id } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { description: @wallet.description, name: @wallet.name, status: @wallet.status, uid: @wallet.uid, user_id: @wallet.user_id } }
